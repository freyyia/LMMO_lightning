...
def PPnP_LMMO():
    ...
    path_save = './results/Results_PPnP_LMMO_' + config_defaults['inverse_problem'] + 'alpha_poisson_{}_delta_frac{}_noise_lvl_{}_alpha_{}_rot_n_flip_{}/'.format(config_defaults['alpha_poisson'], config_defaults['delta_frac'], config_defaults['noise_lvl_denoiser'], config_defaults['alpha'], config_defaults['flip_n_rot'])
    exp_name = 'Results_PPnP_LMMO_' + config_defaults['inverse_problem'] + '_alpha_poisson_{}_delta_frac{}_noise_lvl_{}_alpha_{}_rot_n_flip_{}'.format(config_defaults['alpha_poisson'],config_defaults['delta_frac'], config_defaults['noise_lvl_denoiser'], config_defaults['alpha'], config_defaults['flip_n_rot'])
